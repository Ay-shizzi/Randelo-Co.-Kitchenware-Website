...
const Randelo = () => {
  ...
  return (
    <>
      ...
      <section className="hero bg-heroBg bg-cover bg-center">
      ...
      <section className="delo-testimonials bg-testimonialsBg bg-cover bg-center relative px-8 py-28">
      ...
      <section className="home-made bg-[#cfb4ac] md:grid md:grid-cols-2 md:grid-rows-1 grid grid-cols-1 grid-rows-2">
        ...
        <div className="home-made-img bg-homeMadeBg bg-cover bg-center md:col-start-2 md:col-end-3 md:row-start-1 md:row-end-2 col-start-1 col-end-2 row-start-1 row-end-2"></div>
      </section>
